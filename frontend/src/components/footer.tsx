    ...
    >
      ...
      <Stack alignItems="center" justifyContent="center" width="30%">
        ...
        <Typography
          ...
          gutterBottom
        >
          Student Alumni Connect Cell (SACC) is a student-run organization that
          aims to foster connections between students, alumni, and the
          Institute. SACC provides mentorship, organizes events, and offers
          resources to help students and alumni engage with their alma mater and
          fellow alumni.
        </Typography>
      </Stack>
