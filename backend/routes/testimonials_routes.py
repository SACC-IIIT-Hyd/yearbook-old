...
def add_testimonials():
    try:
        ...
        new_testimonial = Testimonials(id=data['id'], from_id=data['from_id'], to_id=data['to_id'], text=data['text'], date_created=current_time, last_updated=current_time, preference_number=data['preference_number'])
...
def update_testimonials():
    try:
        ...
        if testimonial:
            ...
            testimonial.last_updated = datetime.utcnow()
            testimonial.preference_number = data.get('preference_number', testimonial.preference_number)
